...
<p>STUDENT ACCOUNT INFORMATION</p>
 ...
 $enum = mysql_real_escape_string($enum);
 ...
 {
  mysql_query("UPDATE sms.student SET student_id='$studentid', paid='$paid', enum=$enum' WHERE student_id='$studentid'") 
 or die(mysql_error());
...
// }
 ...
 $result = mysql_query("SELECT *FROM sms.admission_fee a WHERE a.student_id=$std_id")
 or die(mysql_error()); 
