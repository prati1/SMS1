...
<p>STUDENT MARKS INFORMATION</p>
 ...
 //error, display form
 renderForm($std_id,$first, $middle,$last,$Standard_name,$English,$Nepali,$Social,$Maths,$Computer, $ENVE,$Science,$error);
 }
 else
 {
 // save the data to the database
  mysql_query("UPDATE sms.marks2 SET student_id='$studentid', standard_name='$Standard_name', English='$English', Nepali='$Nepali' Maths='$Maths', Science='$Science', Social='$Social', Computer='$Computer', ENVE='$ENVE' WHERE student_id='$studentid'") 
 or die(mysql_error());
...
// }
 ...
 $result = mysql_query("SELECT * FROM sms.marks2 s WHERE s.student_id=$std_id")
 or die(mysql_error()); 
