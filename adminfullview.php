...
*/
	...
	$result = mysql_query("SELECT s.standard_name,s.student_id,CONCAT(first_name, ' ',middle_name,' ', last_name) As Name,CONCAT(gfirst_name, ' ',gmiddle_name,' ', glast_name) As gName,
	gender, DOBad, date_of_admission, student_roll, YEAR(CURDATE()) - YEAR(DOBad) AS age, YEAR(CURDATE()) - YEAR(date_of_admission) AS standard_id, phone_no,CONCAT(address_temp_street,'-',address_temp_ward,',',address_temp_vdcmun,',',address_temp_district,',',address_temp_zone,',',address_temp_country) as temp_address,
	DOBbs,s.email_id AS semail,admitted_std,CONCAT(address_perm_street,'-',address_perm_ward,',',address_perm_vdcmun,',',address_perm_district,',',address_perm_zone,',',address_perm_country) as perm_address,
...
?>
<p><a href="mpdfwhat.php">Print the Data</a></p>
 <div id="printableArea">
   
    </div>
    <input type="button" onclick="myFunction()" value="print student info!" />
</body>
</html>	