...
<p>STUDENT ACCOUNT INFORMATION</p>
 ...
 {
  mysql_query("UPDATE sms.payment2_status SET student_id='$studentid', paid='$paid', status=$status' WHERE student_id='$studentid'") 
 or die(mysql_error());
...
// }
 ...
 $result = mysql_query("SELECT *FROM sms.payment2_status a WHERE a.student_id=$std_id")
 or die(mysql_error()); 
