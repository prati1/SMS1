...
<p>STUDENT MARKS INFORMATION</p>
 ...
 //error, display form
 renderForm($studentid,$Standard_name,$English,$Nepali,$Social,$Maths,$Computer, $ENVE,$Science,$error);
 }
 else
 {
 // save the data to the database
  mysql_query("UPDATE esms.marks1 SET student_id='$studentid', standard_name='$Standard_name', English='$English', Nepali='$Nepali', Maths='$Maths', Science='$Science', Social='$Social', Computer='$Computer', ENVE='$ENVE' WHERE student_id='$studentid'") 
 or die(mysql_error());
 // mysql_query("UPDATE esms.standard set student_id='$studentid',standard_name='$standard_name'") or die(mysql_error());
...
// }
 ...
 $result = mysql_query("SELECT * FROM esms.marks1  s WHERE s.student_id=$std_id")
 or die(mysql_error()); 
