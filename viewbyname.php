...
<!--
	CURRENTLY THIS PAGE IS NOT WORKING AS GET AND POST ONLY ACCEPTS INTEGER VALUES BUT NAME REQUIRES STRING
-->
...
<?php
	...
	$result = mysql_query("SELECT * FROM sms.administration where Name=$name group by student_roll") 
		or die(mysql_error());  
