...
*/
	...
	$result = mysql_query("SELECT s.student_id,CONCAT(first_name, ' ',middle_name,' ', last_name) As Name, s.student_roll,m3.standard_name, English, Nepali, Maths, Science, Social, ENVE, Computer
	from sms.marks3 m3, sms.student s  where m3.student_id=12343 and s.student_id=m3.student_id") 
		or die(mysql_error());
...
$percent=mysql_query("SELECT *, ((English + Nepali + Maths + Science + Social + COALESCE(Computer,0) + COALESCE(ENVE,0))/
	...
	*/
	...
	echo "<p><b>THIRD TERMINAL EXAMINATION</b>";
