...
// or die(mysql_error()); 
 ...
 address_perm_country='$std_perm_country', standard_name='$standard_name' WHERE student_id='$studentid'") 
 or die(mysql_error());
 
 mysql_query("UPDATE sms.guardian SET gfirst_name='$gfirstname',gmiddle_name='$gmiddlename',glast_name='$glastname',phone_no='$phone',
...
// }
 ...
 $std_temp_zone,$std_temp_country,$std_perm_street,$std_perm_ward,$std_perm_vdc,$std_perm_district,$std_perm_zone,$std_perm_country,$gfirstname,$middlename,$glastname,
 $phone,$relation,$guardianemail,$guardian_street,$guardian_ward,$guardian_vdc,$guardian_district,$guardian_zone,$guardian_country,$standard_name,'');
 }
 else
